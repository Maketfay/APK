...
void interrupt  newintC8(...) { changeColor(); print(); oldint70(); }	  // set function for service interrupt	int70
void interrupt  newintC9(...) { changeColor(); print(); oldint71(); }	  // set function for service interrupt	int71
void interrupt  newintCA(...) { changeColor(); print(); oldint72(); }	  // set function for service interrupt	int72
void interrupt  newintCB(...) { changeColor(); print(); oldint73(); }	  // set function for service interrupt	int73
void interrupt  newintCC(...) { changeColor(); print(); oldint74(); }	  // set function for service interrupt	int74
void interrupt  newintCD(...) { changeColor(); print(); oldint75(); }	  // set function for service interrupt	int75
void interrupt  newintCE(...) { changeColor(); print(); oldint76(); }	  // set function for service interrupt	int76
void interrupt  newintCF(...) { changeColor(); print(); oldint77(); }	  // set function for service interrupt	int77
//---------------------------------------NEW INTERRUPTIONS--------------------------------------------
...
void initialize()
{
	...
	outp(0x21, 0xC8);				// ICW2 - base vector for MASTER (C0H)
